...
class PostProcessor:
    ...
    def _is_hallucination(text: str) -> bool:
        ...
        # Pattern 5: classic Whisper noise hallucinations (YouTube-outro
        # phrases from training data — never legitimate user speech)
        lowered = text.lower().strip(" .!?,")
        outro_hallucinations = {
        ...
        if lowered in outro_hallucinations:
            return True
